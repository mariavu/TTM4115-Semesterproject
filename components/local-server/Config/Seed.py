...
def seedDatabase(db):
    user1 = User("USER-1", "vegardnyeng", "Vegard Nyeng", "topsecret", ["ROLE-3", "ROLE-4"], [])
    user2 = User("USER-2", "henirkud", "Henrik Udnes", "letmein", ["ROLE-1", "ROLE-4"] ,["MESSAGE-1", "MESSAGE-3", "MESSAGE-4"])
    ...
    channel1 = Channel("CHANNEL-1", "Intensivavdeling", ["ROLE-1", "ROLE-3"], ["USER-1", "USER-2"])
    channel2 = Channel("CHANNEl-2", "Akutmottak", ["ROLE-4"], [])
